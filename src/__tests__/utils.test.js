		...
		test("handles large tables", () => {
			...
			const largeTable = [
				...
				},
				{
					...
					description:
						"supplied food provisions, e.g. a ships chandler"
				},
				...
				{ name: "Accomptant", description: "accountant" },
				{
					name: "Accoucheur",
					description:
						"a man who assisted women in childbirth - Midwife"
				},
				{
					name: "Accoucheuse",
					description:
						"a Woman who assisted women in childbirth - Midwife"
				},
				{
					name: "Accountant",
					description:
				...
				},
				{
					name: "Ale Tunner",
					description:
						"brewery worker who fills ale casks (tuns) with ale"
				},
				{
					name: "Ale Wife",
				...
				},
				{
					...
					description:
						"a person who cut and polished amber for jewelry"
				},
				{
					name: "Amber Cutter",
				...
				},
				{
					name: "Ambler",
					description:
						"officer of the Royal Stable who broke in horses"
				},
				...
				},
				{
					name: "Annatto Maker",
					description:
						"worked in the manufacture of dyes for paint or printing"
				},
				{
					name: "Annuitant",
					description:
				...
				},
				{
					name: "Anvil Smith",
					description:
						"one who made anvils and hammers for blacksmiths"
				},
				...
				},
				{
					name: "Appraiser",
					description:
						"(Broker) A person who appraised the value of goods."
				},
				{
					name: "Apprentice",
					description:
				...
				},
				{
					name: "Archivist",
					description:
						"a person who kept records of historical value."
				},
				{
					name: "Arkwright",
					description:
				...
				},
				{
					name: "Ashmanshipman",
					description:
						"a Sailor who cleaned the ashes from a ships boiler"
				},
				{
					name: "Assay Master",
					description:
				...
				},
				{
					name: "Assayer",
					description:
						"one who determined the proportions of metal in ore."
				},
				{
					name: "Assessor",
					description:
				...
				},
				{
					name: "Assistant",
					description:
						"assisted someone else in their trade, often a master"
				},
				{
				...
				},
				{
					name: "Back Washer",
					description:
						"cleans the wool in the worsted manufacturing industry"
				},
				{
					name: "Backmaker",
				...
				{ name: "Backster / Baxter", description: "baker" },
				{
					...
					description:
						'kitchen servant, abreviation of: "back of the house"'
				},
				{
					name: "Badger",
					description:
				...
				},
				{
					name: "Bagniokeeper",
					description:
						"a person in charge of a bath house or brothel."
				},
				...
				},
				{
					...
					description:
						"in charge of the cages at the pit head; aka bank manager"
				},
				...
				},
				{
					name: "Barmaid",
					description:
						"serves drinks in an inn, public house or tavern"
				},
				{
					name: "Barman",
					description:
				...
				},
				{
					name: "Barrel Filer",
					description:
						"a person employed in the gun manufacturing industry."
				},
				{
					name: "Barrowman",
					description:
				...
				},
				{
					name: "Bellows Maker",
					description:
						"made bellows used for organs or blacksmiths fires"
				},
				{
					name: "Belly Builder",
				...
				},
				{
					name: "Block Maker",
					description:
						"engraved the blocks used in the printing industry."
				},
				{
					name: "Block Printer",
				...
				},
				{
					name: "Blowfeeder",
					description:
						'a person who fed the fibres into a "blowing machine".'
				},
				{
				...
				},
				{
					...
					description:
						"a person who was provided with accommodation and meals."
				},
				{
				...
				},
				{
					name: "Bobbin Carrier",
					description:
						"worked in spinning and weaving sections of the mills"
				},
				{
					name: "Bobbin Turner",
					description:
				...
				{ name: "Bonnet Maker", description: "made bonnets" },
				{
					...
					description:
						"made the wire base which formed the shape of the bonnet"
				},
				...
				{ name: "Boot Black", description: "polisher of shoes" },
				{
					name: "Boot Clicker",
					description:
						"punched eylet holes using a machine that clicked"
				},
				{
					name: "Boot Closer",
					description:
				...
				},
				{
					name: "Bottom Knocker",
					description:
						"a sagger makers assistant in the pottery industry."
				},
				{
					name: "Bottom Maker",
					description:
				...
				{ name: "Brachygrapher", description: "a shorthand writer" },
				{
					name: "Braider",
					description:
						"made cord by twisting threads or strips of leather"
				},
				...
				{ name: "Brouge Maker", description: "a shoe maker" },
				{
					name: "Brow Girl",
					description:
						"female employed at the pit head, Pit Brow Girl"
				},
				{
					name: "Brownsmith",
				...
				{ name: "Buck Washer", description: "a laundress" },
				{
					...
					description:
						"made the metal points that go in the holes of a belt"
				},
				...
				},
				{
					name: "Cab Driver",
					description:
						"drove a cab. Also Cab Man, Cabman, Cabbie or Carman"
				},
				{
				...
				},
				{
					name: "Caddie",
					description:
						"a boy who carried messages or who ran errands."
				},
				{
					name: "Caddy Butcher",
				...
				},
				{
					...
					description:
						"owner of a cap making factory or establishment"
				},
				...
				},
				{
					name: "Cashmarie",
					description:
						"a person who sold fish usually at inland markets."
				},
				{
				...
				},
				{
					name: "Castrator",
					description:
						"a person who castrated farm animals aka a Gelder."
				},
				...
				},
				{
					name: "Cautioner",
					description:
						"guarantor, one who acts as security for another."
				},
				{
					name: "Ceiler",
				...
				},
				{
					...
					description:
						"looked after the beer, wines and spirits in wine stores"
				},
				{
					name: "Cemmer",
					description:
						"a person who hand combed the yarn before weaving."
				},
				{
					name: "Chaff Cutter",
				...
				},
				{
					name: "Chambermaid",
					description:
						"female servant attending to bedrooms in houses or inns"
				},
				{
					name: "Chamber Master",
					description:
				...
				},
				{
					name: "Chandler",
					description:
						"grocer, dealer or trader; one who makes or sells candles"
				},
				{
				...
				},
				{
					...
					description:
						"sailor that led the singing of shanties on board ship"
				},
				...
				},
				{
					name: "Chiropodist",
					description:
						"a person who treats diseases of the feet &amp; hands."
				},
				{
				...
				},
				{
					name: "Cigar Stripper",
					description:
						"tobacco stripper, part of the cigar making process"
				},
				...
				{ name: "Cleaner, Char", description: "domestic cleaner" },
				{
					name: "Clerk",
					description:
						"general clerical work, also can mean clergyman, cleric"
				},
				...
				{ name: "Coalheaver, Coal labourer", description: "similar" },
				{
					name: "Coal Runner",
					description:
						"a person who attended the coal carts underground."
				},
				{
					name: "Coal Whipper",
					description:
				...
				},
				{
					name: "Cobleman",
					description:
						"a person who used a flat bottomed boat for fishing."
				},
				{
					name: "Cockfeeder",
				...
				{ name: "Coffin Maker", description: "made coffins" },
				{
					...
					description:
						"made coffins and took care of funeral arrangements"
				},
				{ name: "Cohen", description: "a priest" },
				{
					name: "Coiner",
					description:
						"a person who worked at the Mint stamping out coins."
				},
				{
				...
				},
				{
					name: "Comber",
					description:
						"one who operated a combing machine in the mills."
				},
				...
				},
				{
					...
					description:
						"a coppersmith, someone who worked with copper or brass."
				},
				...
				{ name: "Corn Cutter", description: "a podiatrist." },
				{
					name: "Cornet",
					description:
						"the lowest commissioned rank in a cavalry regiment."
				},
				{
					name: "Corn Factor",
				...
				},
				{
					name: "Corn Meter",
					description:
						"an official who measured and weighed the corn at market."
				},
				...
				},
				{
					name: "Couper",
					description:
						"a dealer, Buys and sells, usually cattle and horses."
				},
				{
					name: "Couple Beggar",
					description:
				...
				{ name: "Couranteer", description: "a journalist." },
				{
					name: "Court Factor",
					description:
						"a person who bought and sold courts (small carts)."
				},
				{
					name: "Court Roller",
					description:
						"a person in charge of the court rolls and records."
				},
				{
				...
				},
				{
					...
					description:
						"a judge, often in the Channel Isles or Isle of Man."
				},
				{
					name: "Delivery Clerk",
				...
				},
				{
					name: "Docker",
					description:
						"stevedore, dock worker who loads &amp; unloads cargo"
				},
				{
					name: "Dock Laborer",
					description:
				...
				},
				{
					name: "Dressmaker",
					description:
						"a person who made clothing, particularly dresses."
				},
				{
					name: "Drift Maker",
					description:
				...
				},
				{
					name: "Dubbere",
					description:
						"a cloth dubber, someone who raises the nap of the cloth."
				},
				...
				{ name: "Duffer", description: "peddler of cheap goods" },
				{
					...
					description:
						"collected domestic refuse, a garbage collector"
				},
				{
					name: "Dyer",
					description:
				...
				{ name: "Gabeler", description: "a tax collector." },
				{
					name: "Gaffer",
					description:
						"foreman of a work crew, or an elderly rustic, an old man."
				},
				...
				},
				{
					name: "Galvaniser",
					description:
						"iron worker who coated metal with zinc, to inhibit rust"
				},
				{
					name: "Gamekeeper",
					description:
				...
				},
				{
					...
					description:
						"general labourer, usually lifting and carrying etc"
				},
				{
				...
				{ name: "Gilder", description: "applies gold leaf" },
				{
					name: "Gimler",
					description:
						"a machinist involved in making a gimp, a kind of card."
				},
				...
				{ name: "Glass Blower", description: "maker of glass items" },
				{
					name: "Glass Coachman",
					description:
						"a driver of a two-horse carriage hired out for the day."
				},
				...
				{ name: "Gobar", description: "a jobber." },
				{
					name: "Gold Beater",
					description:
						"someone who beats gold to shape it into something."
				},
				{
					name: "Gold Embroider",
				...
				},
				{
					name: "Goldsmith",
					description:
						"maker of gold articles. Also a nickname for a banker."
				},
				{
				...
				},
				{
					...
					description:
						"a retailer of sand collected from the Greenwich pits."
				},
				{
					name: "Griffin",
					description:
				...
				},
				{
					...
					description:
						"sold almost everything including fruit and veg"
				},
				...
				},
				{
					name: "Gummer",
					description:
						"a person who improved old saws by deepening the cuts."
				},
				...
				},
				{
					name: "Hairweaver",
					description:
						"a weaver of cloth composed wholly or partly of horsehair."
				},
				{
				...
				},
				{
					name: "Handy Man",
					description:
						"odd job man - very handy, lives just around the corner"
				},
				...
				{ name: "Hatter", description: "maker of or dealer in hats" },
				{
					...
					description:
						"peddler - sells things on the streets, matches,laces etc"
				},
				...
				},
				{
					name: "Hedge Looker",
					description:
						"supervised repair of fences and hedges. See Hayward"
				},
				...
				{ name: "Hellier", description: "a slater or tiler of roofs." },
				{
					name: "Helper-Up",
					description:
						"a young boy employed in pits to help other workers."
				},
				{
					name: "Hemp Heckler",
				...
				},
				{
					name: "Henchman",
					description:
						"a horseman or groom, or a Squire, or page of honour."
				},
				...
				},
				{
					name: "Higgler",
					description:
						"a person who haggles or bargains, an itinerant peddler"
				},
				{
					name: "High Sheriff",
					description:
				...
				{ name: "Hoggard", description: "a pig drover." },
				{
					name: "Hog Reeve",
					description:
						"one who rounded up the stray hogs on city streets"
				},
				{
				...
				},
				{
					name: "Horner",
					description:
						"a worker in horn making spoons, combs, or musical horns."
				},
				{
					name: "Horse Capper",
				...
				},
				{
					name: "Hosier",
					description:
						"retailer of stockings, socks, gloves, nightcaps"
				},
				...
				},
				{
					...
					description:
						"someone who made hedges, of wattled framework fencing."
				},
				{
					name: "Hurriers",
					description:
				...
				},
				{
					name: "Husbandman",
					description:
						"a farmer who cultivated the land, tenant farmer"
				},
				{
				...
				},
				{
					...
					description:
						"dealer in hardware made of iron and other products"
				},
				{
					name: "Iron Smith",
				...
				},
				{
					name: "Lace Drawer",
					description:
						"a child employed in lace work, drawing out threads."
				},
				...
				},
				{
					name: "Lady's Tailor",
					description:
						"someone who specialised in tailoring for ladies."
				},
				...
				},
				{
					name: "Latouner",
					description:
						"someone who works with latten, a brass-like metal alloy."
				},
				{
					name: "Lattener",
				...
				},
				{
					...
					description:
						"anyone learning a trade which is not an apprenticeship"
				},
				...
				{ name: "Letter Carrier", description: "a postman" },
				{
					...
					description:
						"a printer using the letterpress printing method."
				},
				...
				{ name: "Licensed Reader, Preach", description: "a preacher" },
				{
					...
					description:
						"one who is licensed to sell alcoholic beverages"
				},
				{
					name: "Lighterman",
				...
				{ name: "Limeburner", description: "a maker of lime." },
				{
					name: "Limner",
					description:
						"a draughtsman or artist. An illustrator or painter."
				},
				{
				...
				},
				{
					name: "Lock Keeper",
					description:
						"someone who oversees the operation of canal locks."
				},
				{
					name: "Lodge Porter",
				...
				},
				{
					...
					description:
						"someone in charge of or owner of a lodging house."
				},
				{
					name: "Lodger",
					description:
						"someone who sleeps in a lodging house. See Boarder."
				},
				{
				...
				},
				{
					name: "Lungs",
					description:
						"an alchemist's servant whose duty was to fan the fire."
				},
				{
					name: "Machine Boy",
				...
				},
				{
					name: "Maise Maker",
					description:
						"a person who made measures for weighing herring catch."
				},
				{
					name: "Maker-Up",
					description:
				...
				},
				{
					name: "Master Lumper",
					description:
						"a contractor of labourers at cheap rate of pay."
				},
				{
					name: "Master Mariner",
				...
				},
				{
					...
					description:
						"head nurse in charge of a ward in an institution."
				},
				...
				},
				{
					name: "Milk Dairyman",
					description:
						"someone who keeps dairy cattle and produces milk."
				},
				{
					name: "Miller",
					description:
						"one who operated a mill; grain, cloth, timber etc."
				},
				{
					name: "Milleress",
				...
				{ name: "Oilman", description: "one who sold oil for lamps." },
				{
					name: "Olitor",
					description:
						"a kitchen gardener, from Olitory; a kitchen garden."
				},
				{
				...
				{ name: "Omnibus Driver", description: "drives an omnibus." },
				{
					name: "Optician",
					description:
						"someone who examines eyes and precribes glasses."
				},
				{
					name: "Orange Peeler",
				...
				},
				{
					name: "Orange Porter",
					description:
						"someone who carries crates of oranges in a fruit market."
				},
				{
					name: "Orderly",
					description:
						"a soldier who acted as a servant for an officer."
				},
				{
				...
				},
				{
					name: "Orrice Weaver",
					description:
						"a weaver of lace patterns in silk thread and silk."
				},
				{
				...
				{ name: "Ostiary", description: "a monastery door keeper." },
				{
					name: "Ostler",
					description:
						"one who looks after horses; stableboy. See Hostler."
				},
				{
				...
				{ name: "Out Crier", description: "an auctioneer." },
				{
					name: "Outrider",
					description:
						"an attendant riding a horse before or behind a carriage."
				},
				{
					name: "Outworker",
				...
				{ name: "Owler", description: "sheep or wool smuggler" },
				{
					name: "Oyster Dredger",
					description:
						"member of the crew on board an oyster fishing boat"
				},
				{
					name: "Packer",
					description:
						"packs goods such as tobacco, pickles or herring"
				},
				{
				...
				},
				{
					...
					description:
						"the operator of the machine which made thread or twine."
				},
				{
					name: "Pad Maker",
					description:
				...
				{ name: "Pantler", description: "a butler." },
				{
					name: "Papaya Man",
					description:
						"someone who was involved in trade with Papua New Guinea."
				},
				...
				},
				{
					...
					description:
						"an interior decorator who hung paper and plastered."
				},
				{
					name: "Paper Maker",
					description:
				...
				},
				{
					name: "Paper Stainer",
					description:
						"a person who coloured paper by hand or machine."
				},
				{
					name: "Parcheminer",
				...
				},
				{
					name: "Pardoner",
					description:
						"someone who is licensed to sell papal indulgences."
				},
				{
					name: "Pargeter",
					description:
						"someone who applied ornamental plaster to buildings."
				},
				{
					name: "Paritor",
					description:
				...
				},
				{
					...
					description:
						"someone who laid paving stones or paved roads."
				},
				{
					name: "Pavyler",
					description:
						"someone who put up marquees, pavilions or tents etc."
				},
				{
					name: "Pawnbroker",
					description:
				...
				{ name: "Pedascule", description: "a school master." },
				{
					name: "Pedlar",
					description:
						"a street seller who bought and sold goods for cash."
				},
				{
					name: "Peeler",
					description:
				...
				},
				{
					...
					description:
						"a skilled craftsman who made scientific instruments."
				},
				{
					name: "Phrenologist",
					description:
				...
				},
				{
					name: "Pickler",
					description:
						"someone who pickled things, eggs, onions beetroot etc."
				},
				...
				},
				{
					name: "Piece Broker",
					description:
						"a person who sold material off-cuts or remnants."
				},
				{
					name: "Piece Worker",
					description:
				...
				},
				{
					name: "Pigmaker",
					description:
						"someone who made pig or cast iron, also a pottery worker."
				},
				{
					name: "Pigman",
					description:
				...
				},
				{
					name: "Piker",
					description:
						"a vagrant or tramp, someone with no fixed abode."
				},
				...
				{ name: "Pistor", description: "a baker or miller." },
				{
					name: "Pit Brow Lass",
					description:
						"a female worker who worked at the pit head of a mine."
				},
				...
				{ name: "Plaisterer", description: "a plasterer." },
				{
					name: "Plaiter",
					description:
						"someone who made straw plaits used in making hats etc."
				},
				{
					name: "Planker",
					description:
				...
				},
				{
					name: "Plumassier",
					description:
						"someone who made or sold plumes, or ornamental feathers."
				},
				{
					name: "Plumber",
					description:
				...
				},
				{
					...
					description:
						"one who worked with lead piping for gas fittings"
				},
				{
					name: "Plumbum Worker",
				...
				{ name: "Polentier", description: "a poulterer." },
				{
					...
					description:
						"a police officer who had achieved the rank of Sergeant."
				},
				{
				...
				},
				{
					name: "Poster",
					description:
						"someone who worked in the quarries breaking rocks."
				},
				{
					name: "Postillion",
					description:
				...
				},
				{
					name: "Postman",
					description:
						"someone who carried letters for the Post Office."
				},
				{
					name: "Pot Boy or Man",
					description:
				...
				},
				{
					name: "Pot Burner",
					description:
						"someone who placed pots in a furnace to be fired."
				},
				{
					name: "Potato Badger",
				...
				},
				{
					...
					description:
						"someone who maintained the loom in a weaving mill."
				},
				{
					name: "Powler",
					description: "a barber, or men's hairdresser."
				...
				{ name: "Prick Louise", description: "a tailor." },
				{
					name: "Pricker",
					description:
						"a pattern maker, or a horseman, or a witch hunter."
				},
				...
				},
				{
					name: "Prop Bobby",
					description:
						"someone who worked in mines checking the pit props."
				},
				...
				},
				{
					name: "Publican",
					description:
						"innkeeper, one who runs a public house, usually licensed"
				},
				{
					name: "Puddler",
					description:
				...
				},
				{
					name: "Purser",
					description:
						"a ship's officer in charge of provisions &amp; accounts"
				},
				{
				...
				},
				{
					name: "Raff Merchant",
					description:
						"someone who sold fibre used to make raffia bags etc."
				},
				{
					name: "Raffman",
				...
				{ name: "Redsmith", description: "a goldsmith." },
				{
					name: "Reeder",
					description:
						"someone who worked with reeds for hedging or thatching."
				},
				{
					name: "Reedmaker",
					description:
				...
				{ name: "Riftere", description: "a reaper." },
				{
					name: "Rigger",
					description:
						"hoist tackle worker; works on a ship's rigging"
				},
				{
				...
				},
				{
					name: "Roll Coverer",
					description:
						"someone who covered the rollers for the spinning process."
				},
				{
					name: "Rolleyway Man",
					description:
						"someone who maintained the underground road in the mines."
				},
				{
					name: "Roman Cementer",
					description:
						"someone who worked with roman cement used in stuccoing."
				},
				...
				},
				{
					name: "Rubbisher",
					description:
						"someone who sorted the small stones in the quarries."
				},
				{
					name: "Rubbler",
					description:
				...
				},
				{
					name: "Runner",
					description:
						"one who solicited business for a hotel, steamship, etc"
				},
				{
					name: "Runner",
					description:
				...
				},
				{
					name: "Sandwichman",
					description:
						"someone who wears a sandwich billboard for advertising."
				},
				...
				},
				{
					name: "Scaffolder",
					description:
						"someone who erected scaffolding for building work."
				},
				{
					name: "Scabbler",
					description:
				...
				},
				{
					name: "Scavelman",
					description:
						"employed to keep the waterways and ditches clear"
				},
				...
				{ name: "School Teacher", description: "a schoolteacher." },
				{
					...
					description:
						"an artisan who carves in bone, ivory, or wood."
				},
				...
				},
				{
					name: "Screener",
					description:
						"someone who screened the ore at the mines surface."
				},
				{
					name: "Scribbler",
					description:
				...
				{ name: "Scrutineer", description: "an election judge" },
				{
					name: "Scullery Maid",
					description:
						"female servant who performed all the menial tasks"
				},
				{
					name: "Scullion",
					description:
						"male servant who performed all the menial tasks"
				},
				{
					name: "Scutcher",
					description:
						"someone who beat the flax to soften the straw."
				},
				{
					name: "Sculptor",
				...
				{ name: "Shanty Man", description: "a lumber man." },
				{
					name: "Sharecropper",
					description:
						"a tenant farmer who would be paid with part of the crop."
				},
				{
					name: "Sharman",
					description:
				...
				},
				{
					name: "Shipwright",
					description:
						"constructor or repairer or ships; a shipbuilder."
				},
				{
					name: "Shoe Finder",
				...
				},
				{
					name: "Shot Firer",
					description:
						"someone in charge of blasting in mines or quarries."
				},
				{
					name: "Shrager",
				...
				{ name: "Shuffler", description: "a yardman on a farm." },
				{
					name: "Shunter",
					description:
						"one who moved rolling stock around the railway yards"
				},
				{
					name: "Shuttle Maker",
					description:
						"someone who made the shuttles for the weaving mills."
				},
				...
				},
				{
					name: "Silk Mercer",
					description:
						"someone who sold silk cloth and items made from silk."
				},
				{
				...
				},
				{
					name: "Skepper",
					description:
						"someone who made or sold wicker or straw beehives."
				},
				{
					name: "Skin Dresser",
				...
				},
				{
					...
					description:
						"someone who made smallware e.g. tapes, braids etc."
				},
				{
					name: "Smelter",
					description:
						"someone who works in a metal smelter, or smelt fishermen."
				},
				...
				{ name: "Soldier", description: "served in the army." },
				{
					...
					description:
						"someone who cut the soles for shoes and boots."
				},
				{
					name: "Solicitor",
					description:
						"a lawyer, a person qualified to carry out legal duties."
				},
				...
				},
				{
					name: "Stationer",
					description:
						"a bookseller, seller of paper &amp; writing implements."
				},
				...
				{ name: "Steersman", description: "a ship's helmsman." },
				{
					name: "Stenterer",
					description:
						"someone who operated the cloth finishing machine."
				},
				{
					name: "Step Boy",
					description:
				...
				{ name: "Stonewarden", description: "a surveyor of highways." },
				{
					name: "Stone Workers",
					description:
						"someone who worked with stone e.g. masons, quarries etc."
				},
				{
					name: "Store Dresser",
				...
				},
				{
					name: "Stowyer",
					description:
						"someone who stowed the nets away on fishing boats."
				},
				...
				},
				{
					name: "Straw Plaiter",
					description:
						"someone who made straw braids for the hat industry."
				},
				{
					name: "Straw-plait manufacturer",
					description:
						"someone who owned a straw plait making factory."
				},
				{
					name: "Streaker",
				...
				},
				{
					...
					description:
						"junior barrister. Stuff Gowsman is probably a misspelling"
				},
				...
				},
				{
					name: "Tarrier",
					description:
						"someone in charge of a pack of terriers used for hunting."
				},
				...
				{ name: "Teinter", description: "a dyer." },
				{
					...
					description:
						"someone who delivers messages sent by telegraph."
				},
				{
					name: "Telegraphist &amp; Clerk",
					description:
						"someone who sends and receives telegraph messages."
				},
				{
					name: "Tenter",
					description:
				...
				{ name: "Thacker", description: "a roof thatcher." },
				{
					name: "Thatcher",
					description:
						"roofer, one who covered roofs with straw or reeds."
				},
				{
					name: "Thirdborough",
					description:
						"an under, or deputy constable. Also a tithing man."
				},
				{
					name: "Thresher",
					description:
						"someone who separated the grain from the husks and straw."
				},
				{
					name: "Throwster",
					description:
				...
				},
				{
					...
					description:
						"someone who sold earthenware from town to town."
				},
				{
					name: "Tide Gauger",
				...
				},
				{
					name: "Times Ironer",
					description:
						"someone responsible for ironing the daily newspaper."
				},
				...
				},
				{
					name: "Tinner",
					description:
						"someone who worked in the tin mines or a tinsmith."
				},
				{
				...
				},
				{
					name: "Tipper",
					description:
						"someone who put the metal tips on arrows, etc."
				},
				{
					name: "Tippler",
				...
				},
				{
					...
					description:
						"someone who made toilinet (a kind of quilting)."
				},
				...
				{ name: "Topsman", description: "the head cattle drover." },
				{
					name: "Touch Holer",
					description:
						"someone who worked in the gun manufacturing industry."
				},
				{
					name: "Tow Card Maker",
					description:
						"someone who made tow cards, used in the textile industry."
				},
				{
				...
				},
				{
					name: "Town Crier",
					description:
						"one who made public announcments in the streets"
				},
				{
					name: "Town Husband",
					description:
				...
				},
				{
					...
					description:
						"someone who sews braid onto the edges of clothing."
				},
				{
					name: "Trimming Maker",
				...
				},
				{
					name: "Ulnager",
					description:
						"examined the quality of woollen goods to be sold"
				},
				...
				},
				{
					name: "Verge Maker",
					description:
						"someone who made the spindles used in clocks and watches."
				},
				{
					name: "Verger",
					description:
				...
				},
				{
					...
					description:
						"a volunteer who visits sick people to cheer them up."
				},
				...
				},
				{
					name: "Warehouse Man",
					description:
						"someone in charge of or employee in a warehouse."
				},
				{
				...
				},
				{
					name: "Watchman",
					description:
						"a town official who guarded the streets at night."
				},
				{
					name: "Water Bailiff",
					description:
				...
				},
				{
					...
					description:
						"someone who transported and sold fresh drinking water."
				},
				{
					name: "Waterman",
					description:
						"someone who worked with or on boats usually on rivers."
				},
				{
				...
				},
				{
					...
					description:
						"a dock labourer who worked on the ships in harbour."
				},
				{
				...
				{ name: "Wharfanger", description: "the owner of a wharf." },
				{
					name: "Wharfinger",
					description:
						"the owner of a wharf, or one who is in charge."
				},
				{
					name: "Wharf Labourer",
				...
				},
				{
					name: "Wheeryman",
					description:
						"someone in charge of a wheery, a small light rowing boat."
				},
				...
				{ name: "Whitear", description: "someone who cleaned hides." },
				{
					name: "White Limer",
					description:
						"someone who plastered walls using lime and water plaster."
				},
				{
					name: "Whitener",
				...
				},
				{
					name: "Wool Labourer",
					description:
						"a general labourer who works in the woollen industry."
				},
				{
					name: "Wool Man",
					description:
						"someone who sorted the wool into different grades."
				},
				{
				...
				},
				{
					name: "Wool Winder",
					description:
						"someone who made up balls of wool for selling."
				},
				{
			...
			for (let i = 0; i < 10000; i++) {
				const result = rollOnTable(largeTable);
				totals[result.name] = totals[result.name]
					? totals[result.name] + 1
					: 1;
				expect(largeTable.includes(result)).toBe(true);
			}
		});
...
describe("biasedSelection", () => {
	test("returns results biased toward given index", () => {
		...
		for (let i = 0; i < 10000; i++) {
			const result = biasedSelection(array, 2, 0.5);
			totals[result]++;
		}
