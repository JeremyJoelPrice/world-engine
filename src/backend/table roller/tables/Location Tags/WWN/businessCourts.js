...
exports.sourceOfPower = [
	"The own rignts to a critic part o- the business",
	...
	"They have tes to an important local tain",
	"They're the only one who can handle the workers well",
	"Their relatives make up a lot o- the workers",
	"The business owes thom a large monetary dob!",
...
exports.internalConflicts = [
	...
	"Someone lost al arge sum or tunds to theft or error",
	...
	"Factions are quarreling over a new produc",
...
exports.externalConflicts = [
	...
	"Their customers are turious over a recent product flow",
