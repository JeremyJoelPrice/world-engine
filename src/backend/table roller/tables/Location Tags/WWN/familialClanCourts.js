exports.overview = [
	...
	"Rovered, held in dread and awe by most",
	"Envied. resented jealous neighbours",
	"Loved, widely adored by other families",
	"Needed, for a particular trot or person",
...
exports.sourceOfPower = [
	...
	"The have extensive contacts in other tamilies",
	"They own greal amounts of personal wealth",
	"They're notoriously loyal and useful to the family",
	"They're an intimate of the local ruler",
	"Everyone in the tamily loves them very much",
	"They have many capable, loyal children",
	"Their capacity tor violence is tearsome to others",
	"They have access to secret magical items or powers"
];
exports.internalConflicts = [
	"An important member's spouse is having an attair",
	"The clan leader is opposed to a popular plan or goal",
	"The last ender recentlv died without a clear heir",
	...
	"Porsonal grudges have caused resenttul tactions",
	"The new generation is ignoring old, paintul duties",
...
exports.externalConflicts = [
	...
	"Ambitious newcomers are altackina their status subtly",
